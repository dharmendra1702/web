export default function Services() {
  return (
    <section className="py-4 pb-10 px-4 md:px-6 overflow-hidden -mt-20 md:mt-0 pt-2 color text-center">

<h2 className="text-3xl font-bold mb-12">Our Services</h2>

<div className="flex justify-center gap-10 flex-wrap">

<div className="group bg-white/5 border border-white/10 p-8 rounded-2xl w-64 hover:bg-linear-to-br hover:from-purple-600/20 hover:to-blue-600/20 transition">
